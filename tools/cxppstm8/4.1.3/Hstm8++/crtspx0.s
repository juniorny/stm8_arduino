...
;
	xref	_main, __inictor, __memory, __idesc__, __stack
...
fbcl:
	...
	incw	y			; pointers
	cpw	y,c_y			; last byte ?
	jrne	fbcl			; and loop back
	ldw	x,c_x			; reload pointer
	addw	x,#7			; next descriptor
	jra	ibcl			; and loop
;
...
;
	call	__inictor		; static constructors
